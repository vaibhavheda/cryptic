...
import 'package:cryptic/utils/storage_manager/storage_manager.dart';

import '../../common/constants/constants_strings.dart' as constants;
import '../../utils/themes/theme_manager.dart';

class CrypticPreferences extends StatefulWidget {
  static String routeName = "/preferences";

  const CrypticPreferences({Key? key}) : super(key: key);

  @override
  State<CrypticPreferences> createState() => _CrypticPreferencesState();
}

class _CrypticPreferencesState extends State<CrypticPreferences> {
